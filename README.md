...
- [4. Setting up](#4-setting-up)
  ...
  - [4.2. Management Portal](#42-management-portal)
  - [4.3. Saving progress](#43-saving-progress)
...
We will open a Management Portal. It will give us access to an HMI where we will be able to create our productions. The portal should be located at the url: http://localhost:52775/csp/sys/UtilHome.csp?$NAMESPACE=IRISAPP. You will need the following credentials: 
