...
![FrameworkFull](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/FrameworkFull.png)
...
![FrameworkAdapted](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/FrameworkAdapted.png)
...
![ExportProgress](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/ExportProgress.png)
...
![ProductionMenu](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/ProductionMenu.png)

We then have to press [New], select the [Formation] package and chose a name for our production: 

![ProductionCreation](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/ProductionCreation.png)
...
![ProductionTesting](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/ProductionTesting.png)
...
![OperationCreation](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/OperationCreation.png)
...
![OperationTest](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/OperationTest.png)
...
![BPMenu](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/BPMenu.png)

## 8.1. Simple BP

We are now in the Business Process Designer. We are going to create a simple BP that will call our operation: 

![BPAddingCall](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/BPAddingCall.gif)
...
![BPContext](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/BPContext.png)
...
![BPBindRequests](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/BPBindRequests.gif)
...
![RMMenu](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/RMMenu.png)

We will create the mapper like this: 

![RMCreation](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/RMCreation.png)

You should now have this Record Map: 

![RMDetails](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/RMDetails.png)
...
![DTCreation](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/DTCreation.png)

Now, we can map the different fields together:

![DTMap](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/DTMap.gif)
...
![BP2ChangeContext](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/BP2ChangeContext.png)

We can then add our transformation (the name of the process doesn't change anything, from here we chose to name it `Main`): 

![BP2AddingTransform](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/BP2AddingTransform.gif)
...
![BP2MsgContext](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/BP2MsgContext.png)
...
![BP2RmToMsg](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/BP2RmToMsg.png)

We need to do the same for `Call BO`. Its input, or `callrequest`, is the value stored in `context.msg`: 

![BP2CallBO](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/BP2CallBO.gif)

In the end, the flow in the BP can be represented like this: 

![BP2Diagram](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/BP2Diagram.png)
...
![ServiceParam](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/ServiceParam.gif)
...
![TestProductionCSV](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/TestProductionCSV.gif)
...
![JDBCProduction](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/JDBCProduction.png)
...
![JDBCParam](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/JDBCParam.png)
...
![JDBCCredentialMenu](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/JDBCCredentialMenu.png)

The login and password are both `DemoData`, as we set up in the `docker-compose.yml` file.

![JDBCCredentialCreation](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/JDBCCredentialCreation.gif)
...
![JDBCService](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/JDBCService.png)
...
![JDBCTest](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/JDBCTest.png)
...
![RESTServiceSetup](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/RESTServiceSetup.png)

To use this service, we need to publish it. For that, we use the [Edit Web Application] menu:

![RESTServicePublish](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/RESTServicePublish.gif)

## 10.3. Testing

Finally, we can test our service with any kind of REST client:

![RESTTest](https://github.com/thewophile-beep/formation-template/tree/master/misc/img/RESTTest.gif)
